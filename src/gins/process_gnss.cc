...
DEFINE_string(txt_path, "/home/crq/workspace_HY/catkin_openhy_lidar/openhy_lidar/data/ginstest.txt", "数据文件路径");
...
int main(int argc, char** argv) {
    ...
    std::ofstream fout("/home/crq/workspace_HY/catkin_openhy_lidar/openhy_lidar/data/gnss_output.txt");
