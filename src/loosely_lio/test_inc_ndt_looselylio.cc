...
int main(int argc, char** argv) {
    ...
    if (FLAGS_save_map) {
        // 把地图存下来
        lm.inc_ndt_lo_->SaveMap("/home/crq/workspace_HY/catkin_openhy_lidar/openhy_lidar/data/1207test09_map3.pcd");
    }
    if (FLAGS_save_path) {
        // 把轨迹存下来
        lm.inc_ndt_lo_->SavePath("/home/crq/workspace_HY/catkin_openhy_lidar/openhy_lidar/data/1207test09_path4.txt");
